// BCGPSymbolizer.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CBCGPSymbolizerApp, CBCGPWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CBCGPSymbolizerApp::OnAppAbout)
...
// CBCGPSymbolizerApp construction

CBCGPSymbolizerApp::CBCGPSymbolizerApp()
{
...
// The one and only CBCGPSymbolizerApp object

CBCGPSymbolizerApp theApp;


// CBCGPSymbolizerApp initialization

BOOL CBCGPSymbolizerApp::InitInstance()
{
	...
	pDocTemplate = new CMultiDocTemplate(IDR_BCGPSymbolizerTYPE,
		RUNTIME_CLASS(CBCGPSymbolizerDoc),
		RUNTIME_CLASS(CChildFrame), // custom MDI child frame
		RUNTIME_CLASS(CBCGPSymbolizerView));
	if (!pDocTemplate)
		return FALSE;
...
// CBCGPSymbolizerApp message handlers

int CBCGPSymbolizerApp::ExitInstance()
{
...
void CBCGPSymbolizerApp::OnAppAbout()
{
	CAboutDlg aboutDlg;
	aboutDlg.DoModal();
}
...
void CBCGPSymbolizerApp::PreLoadState()
{
...
BOOL CBCGPSymbolizerApp::SaveAllModified()
{
